...
const Events = () => {
  ...
  const events = [
    ...
    {
      id: 2,
      title: 'Bellator 300: Freire vs Borics',
      date: '2024-05-01',
      time: '21:00',
      location: 'Ginásio do Ibirapuera, São Paulo',
      category: 'Bellator',
      status: 'upcoming',
      mainEvent: 'Patricio Freire vs Adam Borics',
      image: '/lovable-uploads/ef213dba-e1b7-4b1c-a649-99c8e1860342.png',
      fights: 10,
      viewers: '850K esperados'
    },
    {
      id: 3,
      title: 'ONE Championship: Silva vs Rodriguez',
      date: '2024-04-20',
      time: '23:00',
      location: 'Singapore Indoor Stadium',
      category: 'ONE',
      status: 'live',
      mainEvent: 'Anderson Silva vs Carlos Rodriguez',
      image: '/lovable-uploads/ef213dba-e1b7-4b1c-a649-99c8e1860342.png',
      fights: 8,
    ...
    {
      id: 4,
      title: 'UFC Fight Night: Oliveira vs Makhachev 2',
      date: '2024-04-15',
      time: '20:00',
      location: 'Ginásio do Maracanãzinho, Rio de Janeiro',
      category: 'UFC',
      status: 'finished',
      mainEvent: 'Charles Oliveira vs Islam Makhachev',
      image: '/lovable-uploads/ef213dba-e1b7-4b1c-a649-99c8e1860342.png',
      fights: 11,
      viewers: '3.5M assistiram'
    }
  ];

  const categories = ['todos', 'UFC', 'Bellator', 'ONE', 'PFL'];
  const statusMap = {
